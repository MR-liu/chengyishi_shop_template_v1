...
Line 42:22 Transforming class syntax to the configured target environment ("es5") is not supported yet
Line 43:15 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 55:18 Transforming class syntax to the configured target environment ("es5") is not supported yet
Line 56:19 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 72:16 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 78:16 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 86:14 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 89:20 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 99:21 Transforming class syntax to the configured target environment ("es5") is not supported yet
Line 100:19 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
...
import { timeline } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
import { EffectCarousel } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/theme.js?v=34527309212619288441707962218";
...
import { timeline as timeline2, inView } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
...
import { Delegate } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
...
import { animate, timeline as timeline3, stagger, Delegate as Delegate2 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
import { AnimatedDetails, EffectCarousel as EffectCarousel2, Drawer, throttle } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/theme.js?v=34527309212619288441707962218";
...
import { animate as motionAnimate, scroll } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
...
import { scroll as scroll2, timeline as timeline4, animate as animate2, inView as inView2 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
import { imageLoaded, getHeadingKeyframe } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/theme.js?v=34527309212619288441707962218";
...
import { ScrollArea } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/theme.js?v=34527309212619288441707962218";
...
import { animate as animate3, timeline as timeline5, inView as inView3 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
import { getHeadingKeyframe as getHeadingKeyframe2, throttle as throttle2 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/theme.js?v=34527309212619288441707962218";
...
import { animate as animate4, inView as inView4 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
...
import { timeline as timeline6, inView as inView5 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
...
import { animate as animate5, timeline as timeline7, inView as inView6 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
import { imageLoaded as imageLoaded2 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/theme.js?v=34527309212619288441707962218";
...
import { timeline as timeline8, animate as animate6, stagger as stagger2, inView as inView7 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
import { EffectCarousel as EffectCarousel3, imageLoaded as imageLoaded3, getHeadingKeyframe as getHeadingKeyframe3 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/theme.js?v=34527309212619288441707962218";
...
import { Drawer as Drawer2 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/theme.js?v=34527309212619288441707962218";
...
import { timeline as timeline9, animate as animate7, inView as inView8 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
import { EffectCarousel as EffectCarousel4 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/theme.js?v=34527309212619288441707962218";
...
import { extractSectionId } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/theme.js?v=34527309212619288441707962218";
...
import { scroll as scroll3, timeline as timeline10, ScrollOffset, inView as inView9 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
...
import { animate as animate8, scroll as scroll4 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
...
import { animate as motionAnimate2, timeline as timeline11, inView as inView10 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/vendor.min.js?v=114992621884149252901706766316";
import { EffectCarousel as EffectCarousel5, imageLoaded as imageLoaded4, getHeadingKeyframe as getHeadingKeyframe4 } from "//impact-theme-sound.myshopify.com/cdn/shop/t/6/assets/theme.js?v=34527309212619288441707962218";
